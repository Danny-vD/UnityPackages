...
public class Client : IDisposable {
    ...
    public delegate void UpdateLobbyMemberCallback(Discord.Sdk.ClientResult result,
                                                   ulong userId,
                                                   ulong lobbyId);
    public delegate void LobbyActionCallback(Discord.Sdk.ClientResult result, ulong lobbyId);
    public delegate void PerformOnThreadWithStringCallback(string text);
    public delegate void UpdateUserApplicationProfileCallback(Discord.Sdk.ClientResult result);
