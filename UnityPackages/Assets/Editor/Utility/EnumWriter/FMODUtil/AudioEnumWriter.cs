...
namespace Utility.EnumWriter.FMODUtil
{
	public static class AudioEnumWriter
	{
		...
		private const string subFolder = "Audio/";

		private static readonly string typePath = @$"{Application.dataPath}/{scriptsFolder}/Enums/{subFolder}";
		...
		public static void WriteFmodEventsToEnum()
		{
			...
			WriteToResourcesUtil.WriteToResources(pathNames, "EventPaths.txt", "FmodUtils/");
