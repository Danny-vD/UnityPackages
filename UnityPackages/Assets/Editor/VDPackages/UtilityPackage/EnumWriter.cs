...
{
	public static class EnumWriter //TODO: Use Path class to work with paths instead of manually doing all the slashes
	{
		private static readonly string typePath = Path.Combine(Application.dataPath, VDPackagesConstants.SCRIPTS_FOLDER_PATH);
